...
export default function Nav() {
    ...
    return (
        ...
        <button className="text-white rounded-full pr-10 sm:hidden" onClick={showMenu}>
              ...
              <div id="menu" className={`fixed top-0 w-full left-0 h-screen bg-[#23356B] z-50 hidden lg:hidden p-[20px] ${navbarBg ? "bg-[#050F36]" : ""}`}>
        ...
        <div id="mobile_menu" className="flex flex-col gap-[15px] mb-[40px] text-[#fff]">
          <div>
            <a href="/" id="mobile_menu_about_us" className="mobile_menu" >
          ...
          <div>
            ...
            <span id="mobile_menu_academy" className="mobile_menu my-[40px]" onClick={(event) => toggleMobileMenu(event)}>
              <FormattedMessage id="about"/>
            </span>
            <img className="icon inline-block relative left-[5px]" src="/images/menu_arrow.svg" alt="arrow" />
            <div className="expander flex-col max-h-0 gap-[10px] pt-[10px] overflow-hidden space-y-4 transition-[max-height] duration-700 pl-[15px]">
              <a id="mobile_menu_market_news" className="block" href="/about/ceo">
                <FormattedMessage id="greeting"/>
              </a>
              <a id="mobile_menu_crypto_knowledge" className="block" href="/about/about-us">
                <FormattedMessage id="introCom"/>
              </a>
              <a id="mobile_menu_projects" className="block" href="/about/our">
                <FormattedMessage id="vision"/>
              </a>
            </div>
            </div>
            <div className="mb-[12px]">
            <span id="mobile_menu_about_us" className="mobile_menu my-[40px]" onClick={(event) => toggleMobileMenu(event)}>
              <FormattedMessage id="projects"/>
            </span>
            <img className="inline-block relative left-[5px] icon" src="/images/menu_arrow.svg" alt="arrow" />
            <div className="expander flex-col max-h-0 gap-[10px] pt-[10px] overflow-hidden space-y-4 transition-[max-height] duration-700 pl-[15px]">
              <a id="mobile_menu_about_exchange" className="block" href="/project/ovooTolgoi">
                <FormattedMessage id="OvootHeader"/>
              </a>
              <a id="mobile_menu_team" className="block" href="/project/UurhaiNvvrs">
                <FormattedMessage id="tsankhi"/>
              </a>
            </div>
          </div>
          <div className="mb-[12px]">
            ...
            <img className="inline-block relative left-[5px] icon" src="/images/menu_arrow.svg" alt="arrow" />
            <div className="expander flex-col max-h-0 gap-[10px] pt-[10px] overflow-hidden space-y-4 transition-[max-height] duration-700 pl-[15px]">
              <a id="mobile_menu_about_exchange" className="block" href="/mechanical/mining">
                <FormattedMessage id="strip"/>
              </a>
              <a id="mobile_menu_team" className="block" href="/mechanical/openings">
                <FormattedMessage id="miningSup"/>
              </a>
              <a id="mobile_menu_team" className="block" href="/mechanical/rent">
          ...
          <div className="mb-[12px]">
            ...
            <img className="inline-block relative left-[5px] icon" src="/images/menu_arrow.svg" alt="arrow" />
            <div className="expander flex-col max-h-0 gap-[10px] pt-[10px] overflow-hidden space-y-4 transition-[max-height] duration-700 pl-[15px]">
              <a id="mobile_menu_about_exchange" className="block" href="/posts/news">
                <FormattedMessage id="currentNews"/>
              </a>
              <a id="mobile_menu_team" className="block" href="/posts/corp-news">
                <FormattedMessage id="comNews"/>
              </a>
              <a id="mobile_menu_team" className="block" href="/posts/social-resp">
                <FormattedMessage id="socialRes"/>
              </a>
            </div>
          </div>
          <div className="mb-[12px]">
            ...
            <img className="inline-block relative left-[5px] icon" src="/images/menu_arrow.svg" alt="arrow" />
            <div className="expander flex-col max-h-0 gap-[10px] pt-[10px] overflow-hidden space-y-4 transition-[max-height] duration-700 pl-[15px]">
              <a id="mobile_menu_about_exchange" className="block" href="/humanity/resource-policy">
                <FormattedMessage id="humanPolicy"/>
              </a>
              <a id="mobile_menu_team" className="block" href="/humanity/curriculum">
                <FormattedMessage id="curriculum"/>
              </a>
              <a id="mobile_menu_team" className="block" href="/humanity/hire">
                <FormattedMessage id="availavleJob"/>
              </a>
            </div>
          </div>
          </div>
