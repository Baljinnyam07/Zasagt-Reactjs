...
function PostsMore({ posts, type }) {
  return (
    <>
      <div className="grid justify-center sm:grid-cols-2 sm:justify-center lg:grid-cols-3 gap-[24px] fontSomething">
        {posts.map((post) => (
          <div key={post.id}>
            <div className="bg-white rounded flex flex-col w-full text-[#8F9099]">
              <div className="aspect-video bg-cover inline-block h-1/2 w-full sm:w-full h-max sm:h-[180px]" style={{ backgroundImage: `url("${post.image}")` }}></div>
                ...
                <div className="items-center">
                  <Link className="text-[14px] text-white font-light rounded py-[8px] px-[16px]" to={`/posts/${type}/${post.id}`}>
                    <svg width="54" height="17" viewBox="0 0 54 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path d="M2.66683 9.66675L10.7802 9.66675L7.0535 13.3934L8.00016 14.3334L13.3335 9.00008L8.00016 3.66675L7.06016 4.60675L10.7802 8.33341L2.66683 8.33341L2.66683 9.66675Z" fill="#D0A616"/>
                    </svg>
                  </Link>
                </div>
              </div>
