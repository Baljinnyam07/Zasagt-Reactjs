              ...
              {step === 1 && (
                ...
                <div className="mt-[24px] text-[14px]">
                  ...
                  <div className="mb-6">
                    ...
                    <input type="phone" name="phone" value={formData.phone} onChange={handleFormChange} className="mb-4 rounded-[8px] border w-full xl:w-[282px] h-[40px]"/>
                  </div>
                  <div className="mb-6">
                    <label className="block mb-[8px]">И-мэйл*</label>
                    <input type="mail" name="mail" value={formData.mail} onChange={handleFormChange} className="mb-4 rounded-[8px] border w-full xl:w-[282px] h-[40px]"/>
                  </div>
                  </div>
                </div>
