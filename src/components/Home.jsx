...
const jsonProject =[
  ...
  },
  {
    ...
    caption: 'Монголын өмнөд хэсэгт орших Өмнөговь аймагт оршдог дэлхийн хамгийн том ашиглагдаагүй коксжих болон эрчим хүчний нүүрсний ордуудын нэг бөгөөд нийт 6.4 тэрбум тонн нөөцтэй ба үүний дөрөвний нэг нь сайн чанарын коксжих нүүрс бүхий стратегийн орд юм.',
  },
]
    ...
    <div className='bg-custom-rgba'>
      ...
      <div className='border-y'>
        <div className='grid grid-cols-2 xl:grid-cols-3 text-[#23356B] divide-y divide-x'>
              {jsonItems
              .map((items,index)=>(
                <div key={index} className={`flex items-start ${items.id === 1 ? 'pl-[180px]' : ''} ${items.id === 4 ? 'pl-[180px]' : ''} ${items.id === 3 ? 'pr-[160px]' : ''} ${items.id === 6 ? 'pr-[160px]' : ''}`}>
